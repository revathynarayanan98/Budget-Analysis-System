...
@app.route("/<min_budget>&emsp;&emsp;<max_budget>&emsp;&emsp;<min_profit>&emsp;&emsp;<max_profit>")
def result(min_budget,max_budget, min_profit, max_profit):
   return f"<table><tr><th>Minimum budget</th>&emsp;&emsp;<th>Maximum budget</th>&emsp;&emsp;<th>Minimum profit</th>&emsp;&emsp;<th>Maximum profit</th></tr><tr><td>{min_budget}</td>&emsp;&emsp;<td>{max_budget}</td>&emsp;&emsp;<td>{min_profit}</td>&emsp;&emsp;<td>{max_profit}</td></tr></table>"
